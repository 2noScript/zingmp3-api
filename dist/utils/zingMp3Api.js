...
class ZingMp3Api {
    ...
    hashParam(path, id) {
        return this.getHmac512(path +
            this.getHash256(`ctime=${this.CTIME}id=${id}version=${this.VERSION}`), this.SECRET_KEY);
    }
    hashParamHome(path) {
        return this.getHmac512(path +
            this.getHash256(`count=30ctime=${this.CTIME}page=1version=${this.VERSION}`), this.SECRET_KEY);
    }
    hashCategoryMV(path, id, type) {
        return this.getHmac512(path +
            this.getHash256(`ctime=${this.CTIME}id=${id}type=${type}version=${this.VERSION}`), this.SECRET_KEY);
    }
...
// instance default
exports.ZingMp3 = new ZingMp3Api(env_1.VERSION, env_1.WEB_API, env_1.SECRET_KEY, env_1.API_KEY, String(Math.floor(Date.now() / 1000)) // CTIME
);
